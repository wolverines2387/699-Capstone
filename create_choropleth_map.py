...
## Need to update this and figure out what I'm doing
city = 'boston'
...
agg_neighborhoods_df_city.rename(columns={'total_units': 'Affordable Units Available', 'pct_occupied': '% Affordable Units Occupied', 
                                          'rent_per_month': 'Avg Rent Per Month', 'pct_lt50_median':'% Very Low Income', 'tpoverty':'% In Poverty'}, inplace=True)
